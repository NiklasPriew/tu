...
def ising(L,warmup,mess):
    ...
    x = 0
    print('4')
    T,tempchangem4, tempchangemm4, tempchangemmmm4 = tempchange(4,warmup,mess)
    for x in range(0,100):
        binder4[x] = 1-1/3*(tempchangemmmm4[x]/tempchangemm4[x]**2)
    print('8')
    T,tempchangem8, tempchangemm8, tempchangemmmm8 = tempchange(8,warmup,mess)
    for x in range(0,100):
        binder8[x] = 1-1/3*(tempchangemmmm8[x]/tempchangemm8[x]**2)
    print('16')
    T,tempchangem16, tempchangemm16, tempchangemmmm16 = tempchange(16,warmup,mess)
    for x in range(0,100):
        binder16[x] = 1-1/3*(tempchangemmmm16[x]/tempchangemm16[x]**2)
    print('32')
    T,tempchangem32, tempchangemm32, tempchangemmmm32 = tempchange(32,warmup,mess)

    for x in range(0,100):
        binder32[x] = 1-1/3*(tempchangemmmm32[x]/tempchangemm32[x]**2)
    ...
    plt.figure()
    plt.scatter(T,tempchangemm4, label = '4x4 lattice' )
    plt.scatter(T,tempchangemm8, label = '8x8 lattice' )
    plt.scatter(T,tempchangemm16, label = '16x16 lattice' )
    plt.scatter(T,tempchangemm32, label = '32x32 lattice' )
    plt.xlabel('Temperature')
    plt.ylabel('<M^2>') 
    plt.legend()
    plt.show()
    ...
    plt.figure()
    plt.scatter(T,tempchangemmmm4, label = '4x4 lattice' )
    plt.scatter(T,tempchangemmmm8, label = '8x8 lattice' )
    plt.scatter(T,tempchangemmmm16, label = '16x16 lattice' )
    plt.scatter(T,tempchangemmmm32, label = '32x32 lattice' )
    plt.xlabel('Temperature')
    plt.ylabel('<M^4>') 
    plt.legend()
    plt.show()
